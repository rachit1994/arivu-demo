...
describe("Kalshi /historical/fills route", () => {
  test("returns fills + cursor for valid query", async () => {
    ...
    const req = new Request(
      "http://localhost/api/kalshi/historical/fills?ticker=ev_1&max_ts=1710000000&limit=10",
    );
