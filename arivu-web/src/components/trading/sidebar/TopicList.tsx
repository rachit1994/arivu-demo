...
import { useKalshiMarkets } from "@/lib/kalshi/useKalshiMarkets";
import {
      ...
      <div className="sticky top-0 z-10 -mx-2 mb-2 bg-neutral-950 px-2 pb-2 pt-2">
        <div className="flex flex-wrap gap-1">
          <button
            ...
            className={getCategoryButtonClass(activeCategory === "All")}
          ...
          {MARKET_CATEGORIES.map((c) => (
            <button
              ...
              className={getCategoryButtonClass(activeCategory === c)}
